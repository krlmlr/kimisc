...
#' @description The argument is assumed to be a list of \eqn{n} (named) lists with length \eqn{m} each.  It is converted to a (named) list of \eqn{m} elements with length \eqn{n} each.
