...
#' @description The function `ofactor()` is a convenience wrapper for [factor()]
#'  that orders the levels as they appear in the data if the `levels` argument is not specified.
